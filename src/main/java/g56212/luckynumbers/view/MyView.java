...
/**
 *¨Displays the current player that have attained the end of the game, it means
 * that the winner is printed.
 */
    @Override
...
/**
 * Reads the keyboard's entry and meanwhile verifies if it's the attended value 
 * In this case methods verifies if it's an integer, if it's the case it returns
...
/**
 * Demands to the user to insert a position, the col, then the row. 
 * It allows only to create an position that isn't already occupied or out of
 * the array
